...
namespace ClinicManagementSystem.backend.Features.Authentication.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        /// <summary>
        /// Registers a new patient account and returns an access/refresh token pair.
        /// </summary>
    ...
    CancellationToken cancellationToken)
        {
            ...
            if (!result.Success)
            {
                return BadRequest(ApiResponse<RegisterResponseDto>.FailureResponse(result.Message, result.Errors));
            }

            return Ok(ApiResponse<RegisterResponseDto>.SuccessResponse(result.Data!, result.Message));
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (!result.Success)
            {
                return Unauthorized(ApiResponse<AuthResponseDto>.FailureResponse(result.Message, result.Errors));
            }
